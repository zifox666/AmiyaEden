...
<template>
  <div class="pap-page art-full-height">
    <ElTabs v-model="activeTab" class="pap-tabs" type="border-card">
      ...
      <ElTabPane :label="$t('fleet.pap.allianceCard')" name="alliance">
        <ElCard class="pap-card" shadow="never">
          <template #header>
            <div class="flex items-center justify-between">
            ...
            <div class="flex flex-wrap items-center gap-6 mb-4 px-2">
              ...
              <div class="text-center">
                <p class="text-xl font-semibold text-green-600"
                  >#{{ allianceSummary.monthly_rank }}</p
                >
                <p class="text-xs text-gray-500 mt-1"
                  >{{ $t('fleet.pap.allianceCorpMonthRank') }} /
                  {{ allianceSummary.total_in_corp }}</p
                >
              </div>
              <div class="text-center">
                ...
                <p class="text-xs text-gray-500 mt-1"
                  ...
                  {{ allianceSummary.total_global }}</p
                >
              </div>
              <div class="text-center">
                <p class="text-xl font-semibold text-purple-500"
                  >#{{ allianceSummary.yearly_rank }}</p
                >
          ...
          <div class="pap-table-wrap">
            ...
            >
              ...
              <ElTableColumn prop="pap" :label="$t('fleet.pap.count')" width="80" align="center">
                <template #default="{ row }">
